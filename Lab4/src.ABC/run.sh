...
########## ---------------  C ---------------- ################
 ...
 ./sim -mode 3 -L2sizeKB 512 ../traces/bzip2.mtr.gz  > ../results/C.S512KB.bzip2.res 
 ./sim -mode 3 -L2sizeKB 512 ../traces/lbm.mtr.gz    > ../results/C.S512KB.lbm.res &
 ./sim -mode 3 -L2sizeKB 512 ../traces/libq.mtr.gz    > ../results/C.S512KB.libq.res 
